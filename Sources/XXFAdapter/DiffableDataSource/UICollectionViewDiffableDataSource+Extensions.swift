...
@available(iOS 13.0, *)
@MainActor
extension UICollectionViewDiffableDataSource: @preconcurrency DiffableDataSourceAdapter {
    // MARK: - 🔹 添加 / 更新
    ...
    /// 重新加载多个 section 的所有数据（会替换旧的 snapshot）
    ///
    /// 通常用于全量刷新，如接口返回新数据。
    ///
    /// ```swift
