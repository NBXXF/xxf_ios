    ...
    public extension UICollectionView {
            ...
            where T: Reusable
        {
            ...
            if let nibType = T.self as? NibLoadable.Type {
                register(nibType.nib, forCellWithReuseIdentifier: reuseID)
            } else {
            ...
            where T: Reusable
        {
            ...
            // 自动注册 class 或 nib
            if let nibType = T.self as? NibLoadable.Type {
                register(nibType.nib, forSupplementaryViewOfKind: elementKind, withReuseIdentifier: reuseID)
            } else {
                register(T.self, forSupplementaryViewOfKind: elementKind, withReuseIdentifier: reuseID)
            }
