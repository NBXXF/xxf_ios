    ...
    public extension UITableView {
            ...
            where T: Reusable
        {
            ...
            if let nibType = T.self as? NibLoadable.Type {
                register(nibType.nib, forCellReuseIdentifier: reuseID)
            } else {
                register(T.self, forCellReuseIdentifier: reuseID)
            }
            ...
            where T: Reusable
        {
            ...
            // 自动注册
            if let nibType = T.self as? NibLoadable.Type {
                register(nibType.nib, forHeaderFooterViewReuseIdentifier: reuseID)
            } else {
                register(T.self, forHeaderFooterViewReuseIdentifier: reuseID)
            }
