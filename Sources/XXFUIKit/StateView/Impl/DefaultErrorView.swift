...
/// 默认错误状态视图
@MainActor
open class DefaultErrorView: UIView, IErrorView {
    ...
    /// 是否显示图标
    public var showsImage: Bool = true {
        didSet {
    ...
    /// 图标大小
    public var imageSize: CGSize = CGSize(width: 60, height: 60) {
        didSet {
    ...
    private func setupUI() {
        ...
        // 主布局
        let mainStackView = UIStackView(arrangedSubviews: [imageView, textStackView, retryButton])
